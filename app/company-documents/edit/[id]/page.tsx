...
export default function EditCompanyDocumentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        const data = await response.json()
        throw new Error(data.error || 'Failed to update company document')
      }
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.pageHeader}>
          <div>
            <h2 className={styles.pageTitle}>Edit Company Document</h2>
            <p className={styles.pageSubtitle}>Update company document record</p>
          </div>
          <Link href={`/company-documents/${id}`} className={styles.backButton}>
            ← Back to Details
          </Link>
        </div>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.formActions}>
              ...
              <div className={styles.rightActions}>
                <Link href={`/company-documents/${id}`} className={styles.cancelButton}>
                  Cancel
                </Link>
                <button
                  type="submit"
